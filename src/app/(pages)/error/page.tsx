...
export const metadata: Metadata = {
  ...
  description:
    "The page you are looking for doesn't exist on PropertyLA. Return to our homepage to continue searching for properties, agents, and real estate services in Malaysia.",
};
